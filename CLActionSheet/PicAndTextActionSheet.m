...
//如果tableview處於uiview上面，uiview整個背景有點擊事件，但是我們需要如果我們點擊tableview的時候，處理tableview的點擊事件，而不是uiview的事件。在這裡，我們需要判斷我們點擊事件是否在uiview上還是在uitableview上。
...
{
    [self tappedCancel];
    if (_delegate != nil && [_delegate respondsToSelector:@selector(didSelectedIndex:)]) {
